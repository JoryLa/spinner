...
setTimeout(() => {process.stdout.write('\r|')}, 2500);
setTimeout(() => {process.stdout.write('\r/')}, 2700);
setTimeout(() => {process.stdout.write('\r-')}, 2900);
setTimeout(() => {process.stdout.write('\r\\')}, 3100);
